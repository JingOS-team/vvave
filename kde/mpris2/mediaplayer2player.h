...
public:
    explicit MediaPlayer2Player(TracksModel *playListControler, Player *audioPlayer, bool showProgressOnTaskBar, QObject *parent = nullptr);
...
private:
    ...
    TracksModel *m_playListControler = nullptr;
